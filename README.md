...
Version 1 foundation for Dream Events: a responsive finance and event-management web app designed for GitHub Pages with Google Apps Script + Google Sheets + Google Drive as the business backend.
