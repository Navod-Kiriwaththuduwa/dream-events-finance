...
## V1.4 — Invoice, Payment Plan & Receipt

- Create an invoice from an accepted quotation
- Invoice numbering `DE-INV-YYYY-0001`
- 50/50, 30/70 and custom payment plans
- Record customer payments against invoice/milestones
- Automatic Paid / Partially Paid / Overdue / Outstanding calculation
- Automatic approved Income entry for invoice payments
- Automatic branded receipt generation `DE-RCP-YYYY-0001`
- Event Payments tab with payment history and receipt access
- Sales Documents register now includes quotations, invoices and receipts
- Dashboard/event receivables update from invoice outstanding balances

## V1.3.2 — Quotation Document Refinement

- Whole-LKR quotation rounding
- Dream Events phone: +94 70 628 0480
- Issue date shown on quotation
- Improved quotation line spacing
- Authorized by Dream Events signature area
- Multi-page A4 print improvements
...
1. Package templates
2. File upload to Drive for bills and proofs
3. Refunds/reopen/reversal workflows
4. Inventory reservations and internal cost per use
5. Reimbursements/payables settlement
6. Reports and cash flow
...
Fixes quotation generation for budgets created before V1.3. Main Items no longer suppress customer-visible Sub/Detailed Items. Existing demo budgets work without being recreated.
